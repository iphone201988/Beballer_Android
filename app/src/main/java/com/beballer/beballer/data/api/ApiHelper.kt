...
interface ApiHelper {
    ...
    suspend fun commonParamPostApi(url: String): Response<JsonObject>
    suspend fun apiForRawBodyWithToken(request:HashMap<String, Any>,url: String): Response<JsonObject>
    ...
    suspend fun apiGetOnlyAuthToken(url:String,data: HashMap<String, Any>): Response<JsonObject>
