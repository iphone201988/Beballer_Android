package com.beballer.beballer.ui.organizers.tournament_create.details
...
import com.beballer.beballer.databinding.FragmentOrgTournamentDetailsBinding
import com.beballer.beballer.databinding.RvAddTournamentItemBinding
import com.beballer.beballer.databinding.RvEventSponsorItemBinding
...
@AndroidEntryPoint
class OrgTournamentDetailsFragment : BaseFragment<FragmentOrgTournamentDetailsBinding>(),
    OnMapReadyCallback {
    private lateinit var sponsorsAdapter: SimpleRecyclerViewAdapter<MpvModel, RvEventSponsorItemBinding>
    private lateinit var addTournamentAdapter: SimpleRecyclerViewAdapter<AddTournamentModel, RvAddTournamentItemBinding>
    private val viewModel: OrgTournamentDetailsFragmentVM by viewModels()
    private val translationYaxis = -100F
    private var isFabMenuVisible = false
    private val interpolator = OvershootInterpolator()
    override fun getLayoutResource(): Int {
        return R.layout.fragment_org_tournament_details
    }
    ...
    private fun initSponsorsAdapter() {
        sponsorsAdapter =
            SimpleRecyclerViewAdapter(R.layout.rv_event_sponsor_item, BR.bean) { v, m, pos ->
                when (v.id) {
    ...
    private fun initAddTournamentAdapter() {
        addTournamentAdapter =
            SimpleRecyclerViewAdapter(R.layout.rv_add_tournament_item, BR.bean) { v, m, pos ->
                when (v.id) {
    ...
    private fun getListAddTournament(): ArrayList<AddTournamentModel> {
        return arrayListOf(
            AddTournamentModel("Tournament 1"),
            AddTournamentModel("Tournament 1"),
            AddTournamentModel("", ),
            AddTournamentModel("", ),
