...
import com.beballer.beballer.databinding.FragmentCreateTournamentFirstBinding
...
@AndroidEntryPoint
class CreateTournamentFirstFragment : BaseFragment<FragmentCreateTournamentFirstBinding>() , OnMapReadyCallback {
    ...
    override fun getLayoutResource(): Int {
        return R.layout.fragment_create_tournament_first
    }
                ...
                R.id.cancelImage -> {
                    ...
                    R.id.btnNext -> {
                        if (validate()) {
                            ...
                            viewModel.tournamentData.lat =  places[0].location?.latitude
                            viewModel.tournamentData.long =  places[0].location?.longitude
                            viewModel.tournamentData.ageRange = binding.etAgeRange.text.toString()
                            ...
                            viewModel.tournamentData.long = location?.longitude
                                ...
                                BindingUtils.navigateWithSlide(
                                    findNavController(), R.id.tournamentSecond, null
                                )
                        }
                    }
            }
