...
import com.beballer.beballer.databinding.FragmentCreateCampsFourBinding
...
@AndroidEntryPoint
class CreateCampsFourFragment : BaseFragment<FragmentCreateCampsFourBinding>() {
    ...
    override fun getLayoutResource(): Int {
        return R.layout.fragment_create_camps_four
    }
                        ...
                        if (binding.etTournamentAddress.text?.contains("I already have a link") == true) {
                            if (binding.etAgeRange.text?.isEmpty() == true) {
                                ...
                                BindingUtils.navigateWithSlide(
                                    findNavController(), R.id.createCampsFiveFragment, null
                                )
                            }
                        } else {
                            BindingUtils.navigateWithSlide(
