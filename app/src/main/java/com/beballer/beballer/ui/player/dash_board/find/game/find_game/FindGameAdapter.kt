...
class FindGameAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            TYPE_TEXT -> {
                val binding: FindGameRvItemBinding = DataBindingUtil.inflate(
                    inflater, R.layout.find_game_rv_item, parent, false
                )
    ...
    inner class TextPostViewHolder(private val binding: FindGameRvItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
